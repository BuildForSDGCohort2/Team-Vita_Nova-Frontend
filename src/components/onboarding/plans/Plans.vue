  ...
  <v-responsive>
    <v-container style="max-width: 1000px" grid-list-xl>
      <div :style="{'font-family': 'IBM Plex Sans'}">
        ...
        <v-row :style="{'justify-content': 'center'}">
          <v-col cols="12" md="4">
            <template>
              ...
              >
                <template>
                  <v-card :loading="loading" class="subCard mx-auto pa-2 align-self-auto" flat>
                    <v-card-text>
                ...
                <v-container fill-height fluid pa-2>
                  <v-card-text>
                    <div
                      class="my-4"
                      :style="cardText"
                    >This is the benefit you would get in the startup plan if you registered and subscribe</div>
        ...
        <v-row>
          <v-col cols="12" md="12">
            <h1 class="benefits mt-7">Benefits</h1>
          </v-col>
        ...
        <v-row>
          ...
          <v-divider class="mx-4 ma-3"></v-divider>
        </v-row>
        <v-row>
          <v-col cols="12" md="6">
            <v-row class="ml-5 mr-3">
